...
TIDE_SEARCH_PARAM="--mz-bin-width 0.02 --precursor-window 100 --precursor-window-type ppm --concat F --top-match 1 --use-tailor-calibration T --num-threads 6 --exact-p-value F"


INDEX_DIR=/blob/HUMAN_NT_SHUFFLE_LEN_7-50_COMMON_MOD_1
FILEROOT=nt_shuf_sep_100ppm
